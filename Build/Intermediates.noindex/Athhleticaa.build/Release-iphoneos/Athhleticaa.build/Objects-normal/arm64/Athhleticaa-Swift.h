...
#ifndef ATHHLETICAA_SWIFT_H
#define ATHHLETICAA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Athhleticaa",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Athhleticaa20NotificationDelegate")
...
SWIFT_CLASS("_TtC11Athhleticaa16QCCentralManager")
...
@class NSString;
@class NSNumber;
@interface QCCentralManager (SWIFT_EXTENSION(Athhleticaa)) <CBCentralManagerDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
