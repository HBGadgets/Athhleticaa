        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 32) {
                ...
                VStack(alignment: .leading, spacing: 30) {
                    ...
                    Text("This software and the associated smart ring device are not medical devices; the data and recommendations provided are for reference only and must not be used as basis for clinical diagnosis or treatment. Users should consult a physician before making any medical decisions.")
                }
